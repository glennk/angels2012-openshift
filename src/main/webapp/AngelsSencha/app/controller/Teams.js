Ext.define('AngelsSencha.controller.Teams', {
    ...
    showDetail: function(list, record) {
        ...
        var team_id = record.get('idteams');
        console.log('push() successfully team_id: ' + team_id);
        var tt = Ext.getStore('playerstore');
       
        var results = tt.queryBy(function(qbrecord){
//           console.log('queryByRecord = ' + qbrecord.get('lastname') + qbrecord.get('idteams'));
           var ln = qbrecord.get('idteams');
           if(ln == team_id) {
             return true;
           }	
        });
    ...
    init: function() {
        ...
        Ext.getStore('teamstore').addListener('load', this.onMainStoreLoad, this);
    },
